...
Initially, the lab started on a slow and steady note as this was our first time working with concepts of software testing as a group. The lab document was a bit tough to understand, however, the lab session was helpful for us as we had quite a few questions and concepts cleared by the TAs. Once we started working as a team and came to an understanding, we managed to divide up our workload. The lab document consisted of the concept of "pair testing" which we implemented into our work process, as well as 40 test cases which we managed to divide equally among 4 members. The instructions were unclear at points, but we managed to work through our confusion by discussing our opinions as a group. The lab included the use of GitHub classroom and Jiro, both of which helped us get familiarised with tools we haven't had a chance to work with before. This is beneficial for us as software engineering students as Git is one of the common dominant tools used by companies in the technology industry. Finally, the lab was not extremely overwhelming, thereby giving us the chance to settle down and learn how to work with each other. This would help enhance our performance and teamwork skills, which may make future assignments less of a challenge for us as a group.
